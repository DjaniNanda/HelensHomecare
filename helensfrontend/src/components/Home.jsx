...
export default function Home() {
  ...
  return (
    <>
      <SEO
        title="Helen's Home Care | In-Home Senior Care in Gwinnett County, GA"
        description="Helen's Home Care provides compassionate, non-medical in-home senior care across Gwinnett County and surrounding Atlanta counties. Companion care, personal care, dementia care, and more. Call for a free assessment."
        canonical="/"
      />
    <main className="home">
