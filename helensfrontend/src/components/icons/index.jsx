...
export const ArrowIcon = ({ className = "", size = 16 }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const ChevronIcon = ({ className = "", size = 14 }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const PhoneIcon = ({ className = "", size = 24 }) => (
  ...
  >
    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07
      A19.5 19.5 0 0 1 4.15 12 19.79 19.79 0 0 1 1.08 3.38
      A2 2 0 0 1 3.06 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81
...
export const HandsIcon = ({ className = "", size = 24 }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const CareIcon = ({ className = "", size = 24 }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const WarningIcon = ({ className = "", size = 24 }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width={size} height={size}>
...
export const ArchiveIcon = ({ className = "", size = 24 }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width={size} height={size}>
...
export const XIcon = ({ className = "", size = 24 }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" width={size} height={size}>
