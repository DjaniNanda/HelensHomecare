...
export default function AboutUs() {
  return (
    <>
      <SEO
        title="About Helen's Home Care | Compassionate Senior Care in Gwinnett County"
        description="Learn about Helen's Home Care — our mission, values, and dedicated caregivers serving seniors across Gwinnett County and the greater Atlanta area with dignity and respect."
        canonical="/about"
      />
